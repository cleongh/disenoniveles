...
#+LANGUAGE: es
#+OPTIONS: toc:nil reveal_history:t timestamp:nil date:nil author:t email:t num:nil reveal_single_file:nil inline:nil reveal_slide_number:c reveal_help:t reveal_keyboard:t hash:t
#+reveal_mousewheel:t
#+REVEAL_TRANS: none
#+REVEAL_EXTRA_CSS: base.reveal.css
#+REVEAL_PLUGINS: (search highlight zoom notes)
