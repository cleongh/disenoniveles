...
Si para algún grupo es más sencillo escribir que grabar la voz, podéis enviarlo también así
...
- Hacer un nivel /por habitaciones/: zonas concretas con objetivo concreto
- Cámara correcta: veo lo que necesito y no más siempre
- Luces y elementos para guiar
