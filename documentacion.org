...
#+email: cleon@ucm.es
#+LANGUAGE: es
#+OPTIONS: toc:nil reveal_history:t timestamp:nil date:nil author:nil num:t reveal_single_file:nil inline:nil
...
- Dinámicas de combate complejas y muy depuradas
